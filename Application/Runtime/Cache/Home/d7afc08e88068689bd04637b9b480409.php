	...
	<body>
		...
		<div class="sui-layout">
		  <div class="sidebar" style="width: 80px;background-color:#fafafa;border-right: 1px solid #eee;">
			  ...
			  <li class="active"><a onclick="javascript:openpage('Home/Home/tongji')">统计</a></li>
			  <li><a onclick="javascript:openpage('Home/Home/actlist')">查看</a></li>
			  <li><a onclick="javascript:openpage('Home/Home/add')">添加</a></li>
			  <li class="nav-header">商品</li>
			  <li><a onclick="javascript:openpage('Home/Shop/shoppinglist')">所有 </a></li>
			  <li><a onclick="javascript:openpage('Home/Shop/add')">新增</a></li>
			  <li class="nav-header">个人</li>
			  <li><a onclick="javascript:openpage('Home/User/index')">信息</a></li>
			  <li><a onclick="javascript:openpage('Home/User/zijin')">资金</a></li>
			  <li><a onclick="javascript:openpage('Home/User/set')">设置</a></li>
			</ul>
		  </div>
		  <div class="content" style="margin-left: 0;">
		  	<iframe src="/demo/Home/Home/tongji" id="iframe" onload="changeFrameHeight()"></iframe>
		  </div>
		</div>
